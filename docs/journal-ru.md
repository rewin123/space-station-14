# Инженерный журнал модуля AiAgent (2026-08 — 2026-09)

> Исторический документ. Это бывший `Content.Server/AiAgent/README.md` — хронологический
> журнал эксплуатации и разработки, с замерами, разборами и граблями. Он сохранён целиком, потому
> что в нём лежат обоснования решений, которых нет в коде. Актуальное описание модуля — в
> [`Content.Server/AiAgent/README.md`](../Content.Server/AiAgent/README.md) (на английском).
> Числа и умолчания здесь могут быть устаревшими: источник истины — `AiCVars.cs` и прототипы.
